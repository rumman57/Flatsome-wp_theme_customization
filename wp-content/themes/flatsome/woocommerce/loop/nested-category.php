...
<p><?php if ( $see_more ) : ?><a class="woocommerce-nested-category-layout-see-more button alt-button" href="<?php echo esc_attr( get_term_link( $category ) ) ?>"><?php echo apply_filters( 'wc_nested_category_layout_see_more_message', __( 'See more', WC_Nested_Category_Layout::TEXT_DOMAIN ), $category ); ?></a><?php endif; ?></p>
